...
export default function CheckoutPage() {
  ...
  const handleSubmitOrder = (e: React.FormEvent) => {
    ...
    alert(`Order Confirmed! \nAddress Type: ${addressType.toUpperCase()} \nMethod: ${paymentMethod.toUpperCase()} \nTotal: ৳${total}`);
  };
    ...
    <div className="bg-[#f2f2f7] min-h-screen pb-24 md:py-12 px-4 sm:px-6 lg:px-8 font-['-apple-system',_BlinkMacSystemFont,_'Segoe_UI',_Roboto,_Helvetica,_Arial,_sans-serif] antialiased text-[#1c1c1e]">
      <div className="max-w-5xl mx-auto">
        ...
        <form onSubmit={handleSubmitOrder} className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* LEFT COLUMN: Shipping Address (Col span 7) */}
          <div className="lg:col-span-7 space-y-6">
                ...
                <div className="p-4 bg-slate-50/50">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <button
                      ...
                      className={`p-3 text-left rounded-xl border transition-all active:scale-95 cursor-pointer flex items-center justify-between ${addressType === "home"
                          ? "border-violet-600 bg-violet-50/30 shadow-sm"
                          : "border-slate-200 bg-white hover:bg-slate-50"
                        }`}
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-colors ${addressType === "home" ? "bg-violet-600 text-white" : "bg-slate-100 text-slate-500"
                          }`}>
                      ...
                      <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ml-2 transition-all ${addressType === "home" ? "border-violet-600 bg-violet-600" : "border-slate-300"
                        }`}>
                        {addressType === "home" && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className={`p-3 text-left rounded-xl border transition-all active:scale-95 cursor-pointer flex items-center justify-between ${addressType === "office"
                          ? "border-violet-600 bg-violet-50/30 shadow-sm"
                          : "border-slate-200 bg-white hover:bg-slate-50"
                        }`}
                    >
                      <div className="flex items-center gap-2.5 min-w-0">
                        <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 transition-colors ${addressType === "office" ? "bg-violet-600 text-white" : "bg-slate-100 text-slate-500"
                          }`}>
                          <svg className="w-4.5 h-4.5 stroke-[2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ml-2 transition-all ${addressType === "office" ? "border-violet-600 bg-violet-600" : "border-slate-300"
                        }`}>
                        {addressType === "office" && <div className="w-1.5 h-1.5 rounded-full bg-white" />}
                      </div>
                    </button>
                  </div>
                </div>
            ...
            <div className="flex items-start gap-3 px-4">
              <button
                ...
                className={`mt-0.5 w-5.5 h-5.5 rounded-full flex items-center justify-center shrink-0 border transition-all ${termsAgreed ? "bg-[#34c759] border-[#34c759] text-white" : "border-slate-300 bg-white"
                  }`}
              >
                {termsAgreed && (
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200/50 shadow-sm overflow-hidden p-4 space-y-4">
                ...
                {/* Promo Code Input */}
                <div>
                  <span className="text-[12px] font-bold text-slate-500 block mb-1.5">Promo Code</span>
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-[#f2f2f7] border border-slate-200/80 rounded-xl px-3.5 py-2 text-[13px] placeholder-slate-400 focus:outline-none focus:border-[#007aff] focus:bg-white font-semibold uppercase text-slate-800 transition-all"
                    />
                    <button
                      type="button"
                      onClick={handleApplyCoupon}
                      className="bg-[#007aff] hover:bg-[#0062cc] active:scale-95 text-white font-bold px-4 py-2 rounded-xl text-xs tracking-wider transition-all select-none cursor-pointer shadow-sm"
                    >
                      Apply
                    </button>
                  </div>
                  {couponError && (
                    <p className="text-[11px] text-[#ff3b30] font-semibold mt-1.5 pl-1">{couponError}</p>
                  )}
                </div>
