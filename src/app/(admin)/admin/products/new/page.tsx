...
export default function NewProductPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newProduct = {
      ...
      image: formData.image || "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=450&h=560&fit=crop&q=80",
  ...
  return (
    <div className="space-y-8 font-sans max-w-3xl mx-auto transition-colors duration-200">
      ...
      <div className="space-y-2">
        ...
        <p className="text-slate-550 dark:text-slate-400 text-sm">Fill in details below to publish a new storefront product.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm p-6 md:p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Sleeveless Outfits Black"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            placeholder="Describe the product material, matching details, and fit size..."
