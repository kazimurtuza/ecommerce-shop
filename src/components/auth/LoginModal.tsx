...
export default function LoginModal({ isOpen, onClose }: LoginModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (loginMethod === "phone") {
      ...
      alert(`Successfully logged in with credentials: ${emailOrPhone}`);
      onClose();
    }
  };
          ...
          <div className="space-y-6 max-w-sm mx-auto w-full">
            ...
            <div className="flex border-b border-slate-100 gap-4 mb-4">
              <button
                ...
                className={`flex-1 pb-2 text-xs font-extrabold uppercase tracking-wider text-center border-b-2 transition-all cursor-pointer ${
                  loginMethod === "phone"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex items-stretch border border-slate-200 rounded-xl overflow-hidden focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
                      ...
                      <div className="relative" ref={countryDropdownRef}>
                        <button
                          ...
                          className="flex items-center gap-1 px-2.5 h-full bg-slate-50 border-r border-slate-200 text-xs md:text-sm font-semibold text-slate-700 hover:bg-slate-100 transition-colors focus:outline-none shrink-0 whitespace-nowrap"
                        >
                ...
                <>
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full border border-slate-200 rounded-xl px-4 py-3.5 text-sm text-slate-800 placeholder-slate-400 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                      required
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      ...
                      <Link href="/forgot-password" onClick={onClose} className="text-xs font-bold text-primary hover:underline">
                        Forgot?
                      </Link>
                    </div>
                    <input
              ...
              <button
                type="submit"
                disabled={loginMethod === "phone" ? !phone : (!emailOrPhone || !password)}
                className="w-full bg-primary hover:bg-primary-hover text-white font-extrabold py-3.5 rounded-xl transition-all shadow-md shadow-primary/20 text-sm tracking-wide disabled:opacity-50 disabled:cursor-not-allowed disabled:shadow-none flex items-center justify-center cursor-pointer"
              >
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2.5 w-full border border-slate-200 hover:border-slate-300 hover:bg-slate-50 py-2.5 rounded-xl transition-all duration-200 shadow-sm focus:outline-none cursor-pointer"
